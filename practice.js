...
favoriteThings.car = "My Little Car";
favoriteThings.brand = "a Brand";
...
//rather than my information.
 ...
 user1.name = 'Dayne Snow';
 user1.pwHash = 'Password';
 user1.username = 'dSnow';
...
// Create a function called MakeCard which takes in cardNumber, expirationDate, and securityCode to make a Credit Card object and 
...
function bindCard(person, card) {
  for (let i in person) card[i] = person[i];
  return card;
}